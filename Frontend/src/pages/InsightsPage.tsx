  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-display font-bold text-foreground">AI Insights</h1>
          <p className="text-muted-foreground mt-1">Data-driven insights about solar generation patterns</p>
        </div>
